...
const LandingPage = () => {
   return (
      ...
      <div className="ui container" style={{margin: "auto", width: "100%", padding: "8% 0 0 0"}}>
         <div className="ui container greeting" style={{padding: "0"}}>
            <div className="ui header" style={{fontSize: "0.9em", margin: "0"}}>
                {'Welcome to '}&nbsp;
               <span className="ui grid" style={{display: "inline-block"}}>
                  <div className="nine wide column" style={{padding: '0', paddingRight: '0', color: "black", textAlign: "right"}}> {' meeting'} </div>
                  <div className="seven wide column" style={{padding: '0', color: "#45A29E", textAlign: "left"}}> maker </div>
               </span>
