...
import {
  fetchCurrentGuestSession,
  storeCurrentGuestSession,
  storeCurrentGuestLocal,
  storeCurrentMeeting,
  ...
  return (
    <div style={{ paddingBottom: "4rem", height: "100%" }}>
      ...
      <div style={{ paddingTop: "2rem" }}>
        <Route path="/">
          {" "}
          <LandingPage currentGuest={currentGuest} />{" "}
        </Route>
        <Route path="/create">
          <CreateMeeting
        ...
        <Route path="/edit">
          <EditMeeting currentGuest={currentGuest} socket={socket} />
        </Route>
        <Route path="/join">
          <JoinMeeting onUpdateMeetingID={onUpdateMeetingID} />
        </Route>
        <Route path="/meeting">
          <Meeting
            currentGuest={currentGuest}
